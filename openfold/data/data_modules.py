    ...
    def __getitem__(self, idx):
        ...
        if(self.mode == 'train' or self.mode == 'eval'):
            ...
            if self.use_scn_pdb_names and name in self._scn_path_index:
                ...
                path_pattern = os.path.join(self.data_dir, f"*{rcsb_4letterID.upper()}_*{chain_id.upper()}.pdb")
                try:
                    path = glob.glob(path_pattern)[0]
                except IndexError:
                    # The file name may be in ASTRAL format
                    path = os.path.join(self.data_dir, f"{rcsb_4letterID.upper()}_{chain_id.lower()}.pdb")
