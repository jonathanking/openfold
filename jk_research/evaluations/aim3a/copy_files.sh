...
scp -r h2p:/ihome/dkoes/jok120/openfold/out/experiments/${name}/checkpoints/157-9795.ckpt/ ~/openfold/out/experiments/${name}/checkpoints/

name=resnet_baseline_not_AF2_toastyRN1-FullAF2
mkdir -p ~/openfold/out/experiments/${name}/checkpoints/
scp -r h2p:/ihome/dkoes/jok120/openfold/out/experiments/${name}/checkpoints/178-11097.ckpt/ ~/openfold/out/experiments/${name}/checkpoints/
